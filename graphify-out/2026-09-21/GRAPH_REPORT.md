# Graph Report - DentalCare-Pro-Documentation  (2026-07-28)

## Corpus Check
- 97 files · ~115,272 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 912 nodes · 899 edges · 111 communities (109 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9a294842`
...
Cohesion: 0.11
Nodes (18): 1.1 I tre ruoli, 1.2 Accesso, 1. Introduzione, 2.1 La dashboard, 2.2 L'agenda, 2.3 I pazienti, 2.4 Il Copilot AI, 2. Percorso Segreteria (+10 more)
...
Cohesion: 0.14
Nodes (14): 07 — Sicurezza, 1. Autenticazione (JWT), 2. Autorizzazione (ruoli), 3. Cifratura campo-per-campo (GDPR art. 32) — #7, 4. Altre misure, 5. Postura regolatoria (AI Act, MDR, GDPR), 6. Roadmap sicurezza, Campi cifrati (+6 more)
...
## Knowledge Gaps
- **681 isolated node(s):** `graphify`, `Workflow: graphify`, `1. Studio di Fattibilità & Visione (`docs/01-Studio-di-Fattibilita/`)`, `2. Business Plan (`docs/02-Business-Plan/`)`, `3. Product Roadmap & Specifiche (`docs/03-Product-Roadmap/`)` (+676 more)
